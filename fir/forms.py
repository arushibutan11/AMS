...
'CONVERT_DATE', 'CN_DT', 'CONVERT_FN','BUS_NO', 'BLACK_SPOT', 'BLACK_SPOT_NO', 'FOR_BLK', 'STATUS',
 'F_STATUS','dri_add1','RIDER_HELMET', 'PILLION_HELMET', 'STATE', 'SCANNED', 'HIT_AND_RUN_UPDATE1','VICTIM_PERSON_STATUS','VICTIM_PERSON_STATUS1','MVA_NAME',
'AREA_TYPE','SAREA_TYPE','SOAREA_TYPE','ROAD_LEVEL','GROUND_LEVEL',
 'JUNCTION_CONTROL','ROAD_TYPE','ROAD_TYPE1','SEPERATION','ROAD_CHARACTER','SURFACE_TYPE','SURFACE_CONDITION','ROAD_CONDITION',
'STUDY_PARAMETER','VEHICLE_LOADED_CONDITION','EDU_QUAL'
